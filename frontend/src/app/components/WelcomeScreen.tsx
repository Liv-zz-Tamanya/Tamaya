  ...
  const features = [
    {
      icon: Coffee,
      title: '대화하듯 기록',
      description: '편안하게 이야기하듯 일기를 작성하세요',
    ...
    },
    {
      icon: BookOpen,
      title: '감정 태그 분석',
      description: 'AI가 감정을 분석하고 정리해드려요',
    ...
    },
    {
      icon: BarChart3,
      title: '인사이트 리포트',
      description: '주간/월간 감정 패턴을 확인하세요',
  ...
  return (
    <div className="flex-1 flex flex-col px-6 pt-20 pb-32">
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-sm text-[#5A4A3A] font-diary">
          간단한 3단계로 감정을 기록하세요
        </p>
      </div>
    ...
    <div className="flex-1 flex flex-col px-6 pt-20 pb-32">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-[#5A4A3A] font-diary leading-relaxed">
          자주 기록하고 싶은 감정을 선택하세요<br />
          <span className="text-xs text-[#8B7A6A]">(최소 1개 이상 선택)</span>
        </p>
      </div>
