      ...
      <div className="flex-1 overflow-y-auto smooth-scrollbar px-5 py-6 space-y-5 animate-fade-in">
          ...
          <div className="card-elevated p-6">
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-[#8B7A6A] font-diary">내일 또 만나요 🍷</p>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="card-butler p-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-bold text-[#F7F3EE] mb-2 font-title italic">Butler's Tip</h3>
              <p className="text-sm text-[#E5DDD3] leading-relaxed font-diary">
                매일 꾸준히 감정을 기록하면 자신을 더 깊이 이해할 수 있습니다. 
                작은 감정도 소중히 다뤄주세요.
              </p>
            </div>
          </div>
